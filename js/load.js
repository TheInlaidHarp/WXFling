  ...
  $(document).on("pageInit", "#page-infinite-scroll-bottom", function(e, id, page) {
    ...
    function addItems(number, lastIndex) {
      ...
      for (var i = lastIndex + 1; i <= lastIndex + number; i++) {
        html += '<div class="nothing"></div><a href="findIntegral.html"><li class="list"><h4>糖果 <sup>V1</sup><small>小牛普惠</small></h4><p><span class="keyword">信贷</span><span class="keyword">无资产</span></p><p>客户开砖厂的！想贷几百万！厂房是租用地自建厂房！所以营业执照都有！</p><div class="time"><span>03月17</span><span class="marginBig">13:45</span><b class="text-right">甩单中</b><span class="text-right"><strong>11</strong> 浏览</span><span class="text-right">解锁 <strong>4</strong> 次</span></div><div class="positionUp common">普通打卡</div><div class="positionDown common">换单可高返现</div></li></a>';
      }
      // 添加新条目
